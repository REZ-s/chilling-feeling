...
@Getter
@ToString
public class FruitWine extends BaseAlcoholImpl {

    @Id
    @GeneratedValue(generator = "uuid")
    @GenericGenerator(name = "uuid", strategy = "uuid2")
    @Column(name = "fruit_wine_id", columnDefinition = "BINARY(16)")
    private UUID id;
    ...
    @Builder
    public FruitWine(String name, String engName, String type, UUID id, String aroma, Short soda, Short balance) {
