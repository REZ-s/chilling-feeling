...
@Getter
@ToString
public class Takju extends BaseAlcoholImpl {

    @Id
    @GeneratedValue(generator = "uuid")
    @GenericGenerator(name = "uuid", strategy = "uuid2")
    @Column(name = "takju_id", columnDefinition = "BINARY(16)")
    private UUID id;
    ...
    @Builder
    public Takju(String name, String engName, String type, UUID id, String aroma, Short soda, Short balance) {
