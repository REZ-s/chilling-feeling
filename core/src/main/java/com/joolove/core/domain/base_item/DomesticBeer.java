...
@Getter
@ToString
public class DomesticBeer extends BaseAlcoholImpl {

    @Id
    @GeneratedValue(generator = "uuid")
    @GenericGenerator(name = "uuid", strategy = "uuid2")
    @Column(name = "domestic_beer_id", columnDefinition = "BINARY(16)")
    private UUID id;
    ...
    @Builder
    public DomesticBeer(String name, String engName, String type, UUID id, String aroma, Short soda, Short balance) {
